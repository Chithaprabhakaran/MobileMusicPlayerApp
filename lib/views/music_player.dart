...
import 'package:music_player_app/constants/strings.dart';
import 'package:music_player_app/models/music.dart';
import 'package:music_player_app/views/widgets/lyrics_page.dart';
          ...
          child: Column(
            children: [
              ...
              Expanded(
                  flex: 2,
                  child: Center(
                    child: ArtWorkImage(image: "https://t4.ftcdn.net/jpg/04/17/30/01/360_F_417300125_IuLbNIyPcf1WX36Lp2GXQyJ7rwEDvC14.jpg",),
                  )),
              Expanded(
                  child: Column(
                children: [
